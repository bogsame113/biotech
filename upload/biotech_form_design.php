      ...
      <div id="tabs-1">  
         ...
         <div id="tabs-2"> 
            ...
            <button class="btn btn-primary nextBtn pull-right" style="margin-left:15px;margin-bottom:15px; float:right;display:none">Download CSV</button>
             ...
             <div align="right">
                <label for="dropDownId_banned">Status:</label>
                <select name="dropDownId_banned" id="dropDownId_banned">
                <option value="0">-- Select Status --</option>
                  <option value="Active">Active</option>
                  <option value="Banned">Banned</option>
                </select>
                <input type="button" class="button" value="Banned" id="save_banned" style="margin-top: 11px;">
              </div>
         </div>  
         <div id="tabs-3">  
